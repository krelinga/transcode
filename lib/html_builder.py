...
def h2(*args): return OpenAndCloseTag('h2', *args)
def h3(*args): return OpenAndCloseTag('h3', *args)
def h4(*args): return OpenAndCloseTag('h4', *args)
...
def link(*args): return OpenOnlyTag('link', *args)
def p(*args): return OpenAndCloseTag('p', *args)
def pre(*args): return OpenAndCloseTag('pre', *args)
def section(*args): return OpenAndCloseTag('section', *args)
def style(*args): return OpenAndCloseTag('style', *args)
